...
def recent_search_lookup(search_query, period, max_count = 5000) -> dict:
    ...
    params = get_recent_search_query_params(search_query, period)
    all_responses = []
...
def conversation_lookup(conversation_id) -> dict:
    params = get_conversation_query_params(conversation_id)
    url = 'https://api.twitter.com/2/tweets/search/recent'
...
def followers_lookup(user_id):
    ...
    params = get_followers_query_params()
